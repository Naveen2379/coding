...
/*
let i=1;                //available inside the function f
//const i=1;            //available inside the function f
//var i=1;              //available inside the function f
function f() {
...
if(true) {
    let i=1;
    const f = () => {
        console.log('function expression ', i);
    }
    //f();      //function expression  1        ---->invoking within the same block scope
}
//f();        //ReferenceError: f is not defined

/* function declarations are hoisted to top of the current scope */
for(let i=0;i<3;i++) {
    console.log('loop: ', i);
    function f2() {
